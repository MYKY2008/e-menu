...
if ($token === '') {
    flash('Neplatný alebo chýbajúci token.', 'error');
...
<title>Nové heslo — GastroLink QR</title>
...
<div class="w-full max-w-sm">
  ...
  <div class="text-center mb-8">
    ...
    <p class="text-slate-500 dark:text-slate-400 text-sm">Nastavte nové heslo</p>
  </div>
  ...
  <div class="bg-white dark:bg-slate-900 rounded-[2rem] shadow-sm border border-gray-100 dark:border-slate-800 p-8">
    ...
    <p class="text-sm text-slate-500 dark:text-slate-400 mb-6">
      Zadajte nové heslo pre účet <strong class="text-slate-700 dark:text-slate-300"><?= e($reset['email']) ?></strong>.
    </p>
